...
export const dependencies = [
  { name: "Greenland", code: "GL", parentCode: "DK", parentName: "Denmark", geographicContinent: "North America" },
  { name: "Svalbard", code: "SJ", parentCode: "NO", parentName: "Norway", geographicContinent: "Europe" },
  { name: "Guam", code: "GU", parentCode: "US", parentName: "United States", geographicContinent: "Oceania" },
  { name: "Puerto Rico", code: "PR", parentCode: "US", parentName: "United States", geographicContinent: "North America" },
  { name: "US Virgin Islands", code: "VI", parentCode: "US", parentName: "United States", geographicContinent: "North America", aliases: ["Virgin Islands"] },
  { name: "American Samoa", code: "AS", parentCode: "US", parentName: "United States", geographicContinent: "Oceania" },
  { name: "Northern Mariana Islands", code: "MP", parentCode: "US", parentName: "United States", geographicContinent: "Oceania" },
  { name: "French Guiana", code: "GF", parentCode: "FR", parentName: "France", geographicContinent: "South America" },
  { name: "Guadeloupe", code: "GP", parentCode: "FR", parentName: "France", geographicContinent: "North America" },
  { name: "Martinique", code: "MQ", parentCode: "FR", parentName: "France", geographicContinent: "North America" },
  { name: "Réunion", code: "RE", parentCode: "FR", parentName: "France", geographicContinent: "Africa", aliases: ["Reunion"] },
  { name: "Mayotte", code: "YT", parentCode: "FR", parentName: "France", geographicContinent: "Africa" },
  { name: "French Polynesia", code: "PF", parentCode: "FR", parentName: "France", geographicContinent: "Oceania" },
  { name: "New Caledonia", code: "NC", parentCode: "FR", parentName: "France", geographicContinent: "Oceania" },
  { name: "Saint Martin", code: "MF", parentCode: "FR", parentName: "France", geographicContinent: "North America" },
  { name: "Saint Barthélemy", code: "BL", parentCode: "FR", parentName: "France", geographicContinent: "North America", aliases: ["Saint Barthelemy", "St Barts"] },
  { name: "Wallis and Futuna", code: "WF", parentCode: "FR", parentName: "France", geographicContinent: "Oceania" },
  { name: "Bermuda", code: "BM", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "Cayman Islands", code: "KY", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "British Virgin Islands", code: "VG", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "Turks and Caicos Islands", code: "TC", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "Anguilla", code: "AI", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "Montserrat", code: "MS", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "North America" },
  { name: "Falkland Islands", code: "FK", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "South America" },
  { name: "Gibraltar", code: "GI", parentCode: "GB", parentName: "United Kingdom", geographicContinent: "Europe" },
  { name: "Aruba", code: "AW", parentCode: "NL", parentName: "Netherlands", geographicContinent: "North America" },
  { name: "Curaçao", code: "CW", parentCode: "NL", parentName: "Netherlands", geographicContinent: "North America", aliases: ["Curacao"] },
  { name: "Sint Maarten", code: "SX", parentCode: "NL", parentName: "Netherlands", geographicContinent: "North America" },
  { name: "Hong Kong", code: "HK", parentCode: "CN", parentName: "China", geographicContinent: "Asia" },
  { name: "Macau", code: "MO", parentCode: "CN", parentName: "China", geographicContinent: "Asia" },
  { name: "Faroe Islands", code: "FO", parentCode: "DK", parentName: "Denmark", geographicContinent: "Europe" },
  { name: "Cook Islands", code: "CK", parentCode: "NZ", parentName: "New Zealand", geographicContinent: "Oceania" },
  { name: "Niue", code: "NU", parentCode: "NZ", parentName: "New Zealand", geographicContinent: "Oceania" },
];
